...
class VendingMachine:
    ...
    def vend(self):
        if self.current_balance > self.price and self.num > 0:
            self.balance_copy = self.current_balance
            self.current_balance = 0
            self.num -= 1
            return 'Here is your {} and ${} change.'.format(self.name, self.balance_copy - self.price)
        elif self.current_balance == self.price and self.num > 0:
            ...
            return 'You must add ${} more funds.'.format(self.price - self.current_balance)

    def add_funds(self, input_money):
        if self.num == 0:
            return 'Inventory empty. Restocking required. Here is your ${}.'.format(input_money)
        else:
            self.current_balance += input_money
