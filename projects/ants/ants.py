...
class NinjaAnt(Ant):
    ...
    def action(self, gamestate):
        ...
        for bees in self.place.bees:
            if bees.armor > self.damage:
                remaining_bees.append(bees)
        for bees in remaining_bees:
    ...
    def action(self, gamestate):
        ...
        if self.imposter:
            ...
            while curr_place is not None:
                ...
                if isinstance(curr_place.ant,
                              ContainerAnt) and curr_place.ant.contained_ant and not curr_place.ant.contained_ant.buffed:
